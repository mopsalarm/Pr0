...
import com.pr0gramm.app.api.gif2webm.StatusResponse;
...
public class GifToWebmService {
    ...
    @Inject
    public GifToWebmService(Api api) {
        this.api = api;
    }
    ...
    public Observable<Result> convertToWebm(String url) {
        ...
        return api.convert(encoded)
                .map(result -> new Result(Api.DEFAULT_ENDPOINT + result.getPath(), true))
