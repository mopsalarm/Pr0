 ...
 */
public class SimplifiedAndroidVideoView extends SurfaceView {
    ...
    public SimplifiedAndroidVideoView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
